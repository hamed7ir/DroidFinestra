...
namespace DroidFinestra.UI
{
    ...
    public sealed class CloseChoiceDialog : ThemedDialog
    {
        ...
        public CloseChoiceDialog() : base("Close " + AppIdentity.Name, 440, 288)
        {
            _msg = new Label
            {
                Text = "Keep " + AppIdentity.Name + " running in the tray, or exit completely?\n\nMinimizing keeps running scrcpy sessions alive; exiting ends them.",
                AutoSize = false,
                Height = 104,
