...
namespace DroidFinestra.UI
{
    ...
    public sealed class ConfirmDialog : ThemedDialog
    {
        ...
        public static bool Ask(IWin32Window owner, string message, string title = null, string yesText = "Yes", string noText = "No")
        {
        ...
        public static void Info(IWin32Window owner, string message, string title = null)
        {
        ...
        private ConfirmDialog(string title, string message, string yesText, string noText)
            : base(title ?? AppIdentity.Name, W, 46 + 60 + BodyH(message) + 20)
        {
